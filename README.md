...
A small survey built to ask questions to a group of friends to organize a party.
...
```
git clone --depth=1 https://github.com/aloisdg/amaury-party.git my-project-name
cd my-project-name
npm install
```
